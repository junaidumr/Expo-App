...
const fourth = () => {
  return (
    <View style={{flex:1, backgroundColor:"black", alignItems:"center", justifyContent:"center"}}>
      ...
      <View style={{position:"absolute", top:20, left:-1}}>
        <TouchableOpacity onPress={()=>router.push("./login")} style={{ width:50, height:50, justifyContent:"center", alignItems:"center" , borderRadius:10 }} >
          <Text style={{color:"white", fontSize:20}}> Skip </Text>
        </TouchableOpacity>
      </View>

      <View style={{position:"absolute", top:670, left:-1}}>
        <TouchableOpacity onPress={()=>router.push("third")} style={{ width:50, height:40, backgroundColor:"blue", justifyContent:"center", alignItems:"center" , borderRadius:10 }} >
       ...
       <View style={{position:"absolute", top:670, left:290}}>
        <TouchableOpacity style={{ width:100, height:40, backgroundColor:"#8875FF", justifyContent:"center", alignItems:"center" , borderRadius:10 }} onPress={()=> router.push("./fifth")}>
